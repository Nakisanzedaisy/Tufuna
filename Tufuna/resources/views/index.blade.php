...
<head>
    ...
    <!--CSS for imported landing page start
...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Saving Incentives</a>
                        <div class="dropdown-menu border-light m-0">
                            <a href="savingincentives" class="dropdown-item">Daily</a>
                            <a href="feature.html" class="dropdown-item">Weekly</a>
                            <a href="team.html" class="dropdown-item">Monthly</a>
                           <!-- <a href="testimonial.html" class="dropdown-item">Testimonial</a>
                            <a href="404.html" class="dropdown-item">404 Page</a>-->
                        </div>
                    </div>
                    <!--<a href="index.html" class="nav-item nav-link active">Saving Incentives</a>
                    <a href="service.html" class="nav-item nav-link">Investment</a>-->
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Financial Literacy</a>
                        <div class="dropdown-menu border-light m-0">
                            <a href="project.html" class="dropdown-item">Articles</a>
                            <a href="feature.html" class="dropdown-item">Blogs</a>
                            <!--<a href="team.html" class="dropdown-item">Poultry</a>
                            <a href="testimonial.html" class="dropdown-item">E-commerce</a>
                            <a href="404.html" class="dropdown-item">404 Page</a>-->
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Investment</a>
                        <div class="dropdown-menu border-light m-0">
                            <a href="project.html" class="dropdown-item">Agriculture</a>
                            <a href="feature.html" class="dropdown-item">Sacco</a>
                            <a href="team.html" class="dropdown-item">Poultry</a>
                            <a href="testimonial.html" class="dropdown-item">E-commerce</a>
                            <a href="404.html" class="dropdown-item">404 Page</a>
                        </div>
    ...
    <div class="coins">
            <img src="img/save.jpg" height="400px" width="400px">
        </div>
            <h1 id="today" style="margin-left:190px;">Start saving<br>today!</h1>

            <a href="home"><button id="Start" style="background-color:aquamarine; margin-left:190px;">GET STARTED</button></a>
    
            <div class="middle">
                <h1> Join thousands<br> of young people <br> in Africa<br> and take control of<br> your finances</h2>
        
                <div class="images"> 
                    <img src="img/educ.jpg" height="150px" width="150px">
                    <img src="img/partner.jpg" height="150px" width="150px">
                    <div class="row">
                        <p>Build your financial knowledge<br> and skills with our financial articles,<br> and blogs on topics<br>such as budgeting,<br>saving,investments and more</p>
                        <p class="p2">Learn about our<br> partnerships with other<br>organizations that are<br>working to promote<br>a savings culture among young people. </p>
        ...
        <div class="Services">
            ...
            <div class="cards" style="padding-left: 180px; padding-right: 20px;">
                <div class="save" style="background-color: rgb(166, 161, 161); border-radius: 12px;">
                    <img src="img/goal.jpg" height="150px" width="120px" style="border-radius: 12px; padding-top: 20px; border-top-left-radius: 12px;">
                    <h2>Saving Goals</h2>
                    <p>Get advice from our experts and tips on how to save money,reduce expenses and achieve your financial goals</p><br><br>
            
                </div>

                <div class="phone" style="background-color: rgb(166, 161, 161); border-radius: 12px;">
                    <img src="img/track.jpg" height="150px" width="120px" style="border-radius: 12px; padding-top: 20px;">
                    <h2>Saving Incentives</h2>
                    <p>Get rewarded for saving with our incentives program which offers promos for our new clients</p>
                </div>

                <div class="goals" style="background-color: rgb(166, 161, 161); border-radius: 12px;">
                    <img src="img/tips.jpg" height="150px" width="120px" style="border-radius: 12px; padding-top: 20px;">
                    <h2>Saving Tips</h2>
             
                    <p>Set savings goals,track your progress and celebrate your achievements with our platform</p>
                </div>
    ...
    <div class="para">
        <div class="connect"></div>
            <p class="p3">Connect with other savers,ask questions,share your <br>experiences and provide support to each other in our <br>community forum</p>
    ...
    <div class="tools">
        <h2 class="hs">Saving Tools</h2>
        <p>Use our savings calculators, budgeting tools and goal trackers to help you stay on track and save money more effectively.</p>
        <a href="signup"><button style="background-color:aquamarine; margin-left:-10px;"> Explore</button></a>
    </div>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/save.png" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/Coins count.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                    ...
                    <div class="row g-4 align-items-center">
                            ...
                            <div class="row g-4">
                                <div class="col-12 wow fadeIn" data-wow-delay="0.3s">
                                    <div class="feature-box border rounded p-4">
                                        ...
                                        <p class="mb-3">Through use of a scalable infrastructure by using a cloud-based infrastructure that can easily scale up or down as needed. This can help ensure that your website </p>
                        ...
                        <div class="col-md-6 wow fadeIn" data-wow-delay="0.7s">
                            <div class="feature-box border rounded p-4">
                                ...
                                <p class="mb-3">We ensure user data privacy and security: We implemented measures to ensure that user data is kept private and secure, such as using encryption and multi-factor authentication. This can help build trust with users and protect their financial information.</p>
                ...
                <div class="col-lg-4">
                    <div class="nav nav-pills d-flex justify-content-between w-100 h-100 me-4">
                        <button class="nav-link w-100 d-flex align-items-center text-start border p-4 mb-4 active"
                            ...
                            <h5 class="m-0"><i class="fa fa-bars text-primary me-3"></i>Saving Planning</h5>
                        </button>
                        ...
                        <button class="nav-link w-100 d-flex align-items-center text-start border p-4 mb-0"
                            ...
                            <h5 class="m-0"><i class="fa fa-bars text-primary me-3"></i>Financial Loans</h5>
                        </button>
                    </div>
                </div>
                <div class="col-lg-8">
